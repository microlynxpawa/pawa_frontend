                ...
                <div className="card-body">
                  <div className="row mb-2">
                    <div className="col-sm-5">
                      <a href="/add-client" className="btn btn-primary mb-2"> Add Client</a>
                    </div>
                    <div className="col-sm-7">
                      <div className="text-sm-end">
                        <a href="/add-business-client" className="btn btn-light mb-2 me-1">Add Business Client</a>
                      </div>
                    </div>
                    {/* end col*/}
                  </div>
                  ...
                  <div className="row mb-2">
                    <div className="col-sm-5">
                      <a href="javascript:void(0);" className="mb-2 text-dark">Display
